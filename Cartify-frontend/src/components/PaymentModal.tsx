...
export const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  const isValidUpiApp = (app: string) => {
    const validApps = ['gpay', 'phonepe', 'paytm', 'amazonpay', 'whatsapp', 'bhim'];
    ...
    setTimeout(() => {
      ...
      const orderData = {
        ...
        paymentDetails: paymentMethod === 'card'
          ? { cardType: selectedCardType, last4: cardDetails.number.slice(-4) }
          : paymentMethod === 'upi'
            ? {
              upiApp: selectedUpiApp || null,
              upiId: upiId || null,
              upiMethod: selectedUpiApp ? 'App' : 'Manual'
            }
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="border border-brand-200 dark:border-brand-700 rounded-lg overflow-hidden">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <span className={`font-medium ${paymentMethod === 'card' ? 'dark:text-white' : 'dark:text-brand-300'}`}>Credit/Debit Card</span>
                      </div>
                  ...
                  <div className="border border-brand-200 dark:border-brand-700 rounded-lg overflow-hidden">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <span className={`font-medium ${paymentMethod === 'upi' ? 'dark:text-white' : 'dark:text-brand-300'}`}>UPI</span>
                      </div>
                  ...
                  >
                    ...
                    <span className={`font-medium ${paymentMethod === 'cod' ? 'dark:text-white' : 'dark:text-brand-300'}`}>Cash on Delivery</span>
                  </button>
                </div>
              </div>
