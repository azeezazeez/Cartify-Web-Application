...
public class OrderStatsDTO {
    ...
    private List<com.auxera.backend.dto.admin.AdminOrderDTO> recentOrders;
    ...
    public List<com.auxera.backend.dto.admin.AdminOrderDTO> getRecentOrders() { return recentOrders; }
    public void setRecentOrders(List<com.auxera.backend.dto.admin.AdminOrderDTO> recentOrders) { this.recentOrders = recentOrders; }
}
